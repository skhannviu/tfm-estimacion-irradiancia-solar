# Anexo: Declaración de uso de Gemini (Google)

## 1. Alcance y propósito
Durante la realización de este Trabajo Fin de Máster, la herramienta **Gemini (Google)** se ha utilizado como asistente técnico para el apoyo en la programación, depuración de código y estructuración de la documentación experimental dentro de los cuadernos de Jupyter. Su uso se extiende desde mayo de 2025, empleando la versión **3.1 Pro** para código y notebook, la versión estándar disponible en ese momento para bibliografía, y la versión **3.5 Flash** durante 2026 para la comprobación de información reciente.
...
| :--- | :--- | :--- | :--- |
| **Implementación técnica** | 2025-2026 | Soporte en *notebooks* de Jupyter | Asistencia en la estructura de código para modelos de ML (Random Forest, SVR, Gradient Boosting, MLP, KNN, Voting Regressor) y formateo de celdas. |
| **Depuración y optimización** | 2025-2026 | Resolución de errores de código | Identificación de errores de sintaxis y manejo de datos (*KeyError*), refactorización de scripts de modelos físicos (Erbs, Kasten, Maxwell, Perez). |
