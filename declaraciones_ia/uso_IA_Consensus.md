# Anexo: Declaración de uso de Consensus

## 1. Alcance y propósito
Durante la fase de investigación documental de este Trabajo Fin de Máster, la herramienta **Consensus (versión gratuita)** se ha utilizado como motor de búsqueda automatizado para la localización de artículos académicos y científicos, apoyando la construcción del marco teórico y el estado del arte. Su uso se concentra en junio de 2026.

## 2. Resumen de interacciones por enfoque de búsqueda

| Fase de investigación | Periodo | Propósito de la consulta | Tipo de asistencia recibida |
| :--- | :--- | :--- | :--- |
| **Exploración preliminar** | Junio 2026 | Identificación de literatura base | Búsquedas iterativas para recopilar estudios fundamentales sobre la estimación general de la irradiancia solar. |
